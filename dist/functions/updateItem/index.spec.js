...
var assertOnUpdateItem_1 = __importDefault(require("../utils/assertOnUpdateItem"));
...
var updateItem = jest.fn(function (_a) {
    var patch = _a.patch, id = _a.id;
    return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, Promise.resolve({ item: patch })];
        });
    });
});
describe('@updateItem', function () {
    ...
    var notFoundOptions = {
        ...
        expectedParams: __assign({}, expectedParams, { id: notExistingId, patch: __assign({}, testItem_1.default, { id: notExistingId }) }),
    };
    it('throws not found error when item does exist', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnUpdateItem_1.default(__assign({}, defaultOptions, notFoundOptions, { status: http_status_codes_1.NOT_FOUND, url: constants_1.TEST_URL + "/" + notExistingId }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('throws not found error when item does exist and envelope is enabled', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnUpdateItem_1.default(__assign({}, defaultOptions, notFoundOptions, { params: {
                            envelope: true,
    ...
    it('updates item', function () { return __awaiter(_this, void 0, void 0, function () {
        var updatedItem;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, assertOnUpdateItem_1.default(__assign({}, defaultOptions, { body: updatedItem, expectedParams: __assign({}, expectedParams, { patch: updatedItem }) }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
