...
var updateItem = function (config) { return function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, config.service.updateItem({
                                            filter: config.createFilter({ filter: filter, req: req, res: res }),
                                            id: req.params.id,
                                            patch: config.createPatch({ document: req.body, req: req, res: res }),
                                        })];
                                case 1:
                                    item = (_a.sent()).item;
