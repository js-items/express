...
var assertOnGetItem_1 = __importDefault(require("../utils/assertOnGetItem"));
...
var getItem = jest.fn(function (_a) {
...
var url = constants_1.TEST_URL + "/" + notExistingId;
var defaultOptions = {
    client: request,
    getItem: getItem,
    url: url,
...
describe('@getItem', function () {
    ...
    it('throws error when item not found', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnGetItem_1.default(__assign({}, defaultOptions, { status: http_status_codes_1.NOT_FOUND }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('throws error when item id exists but filter does not match', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnGetItem_1.default(__assign({}, defaultOptions, { expectedParams: {
                            filter: {
    ...
    it('get item when envelope is enabled and pretty response is disabled', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnGetItem_1.default(__assign({}, defaultOptions, { expectedParams: {
                            filter: {
    ...
    it('successfuly get item', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertOnGetItem_1.default(__assign({}, defaultOptions, { expectedParams: {
                            filter: {
