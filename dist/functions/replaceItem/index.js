...
var replaceItem = function (config) { return function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var transactionHandler;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                transactionHandler = defaultTo_1.default(config.defaultTransactionHandler)(config.beforeReplaceItem);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, config.service.replaceItem({
                                            filter: config.createFilter({ filter: filter, req: req, res: res }),
                                            id: req.params.id,
